...
class DictionaryCog(Cog):
    ...
    @cog_ext.cog_slash(
        ...
        options=[
            ...
            create_option(
                "origin_language", "어원 언어", SlashCommandOptionType.STRING, True
            ),
            ...
            create_option(
                "adjective", "형용사 의미", SlashCommandOptionType.STRING, False
            ),
            ...
            create_option(
                "postposition", "조사 의미", SlashCommandOptionType.STRING, False
            ),
            create_option("note", "비고", SlashCommandOptionType.STRING, False),
        ],
    )
    async def zasok_create(
        self,
        ctx: SlashContext,
        word: str = "",
        origin_language: str = "",
        ...
        embed = Embed(
            title=f"자소크어 `{word}` 단어 추가",
            description="자소크어 단어를 추가합니다.",
            color=get_const("shtelo_sch_vanilla"),
        )
